                        ...
                        <div className="row">
                            <div className="col-lg-5 col-md-12 mb-3">
                                <div className="col-12 mb-3">
                                    <div className="img-large border" style={{ backgroundImage: `url("/images/image-1.jpg")` }}></div>
                                </div>
                                <div className="col-12">
                                    <div className="row">
                                        ...
                                        <div className="col-sm-2 col-3">
                                            <div className="img-small border" style={{ backgroundImage: `url("/images/image-2.jpg")` }} data-src="images/image-2.jpg"></div>
                                        </div>
                                        <div className="col-sm-2 col-3">
                                            <div className="img-small border" style={{ backgroundImage: `url("/images/image-3.jpg")` }} data-src="images/image-3.jpg"></div>
                                        </div>
                                        <div className="col-sm-2 col-3">
                                            <div className="img-small border" style={{ backgroundImage: `url("/images/image-4.jpg")` }} data-src="images/image-4.jpg"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="col-lg-2 col-md-3 text-center">
                                <div className="col-12 border-left border-top sidebar h-100">
                                    <div className="row">
                                        ...
                                        <div className="col-12 mt-3">
                                            <button className="btn btn-outline-secondary btn-sm" type="button"><i className="fas fa-heart mr-2"></i>Add to wishlist</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                                    ...
                                                    <ul className="rating-list mt-3">
                                                        <li>
                                                            ...
                                                            <div className="rating-progress-label">
                                                                5<i className="fas fa-star ml-1"></i>
                                                            </div>
                                                        </li>
                                                        <li>
                                                            <div className="progress">
                                                            ...
                                                            <div className="rating-progress-label">
                                                                4<i className="fas fa-star ml-1"></i>
                                                            </div>
                                                        </li>
                                                        <li>
                                                            <div className="progress">
                                                            ...
                                                            <div className="rating-progress-label">
                                                                3<i className="fas fa-star ml-1"></i>
                                                            </div>
                                                        </li>
                                                        <li>
                                                            <div className="progress">
                                                            ...
                                                            <div className="rating-progress-label">
                                                                2<i className="fas fa-star ml-1"></i>
                                                            </div>
                                                        </li>
                                                        <li>
                                                            <div className="progress">
                                                            ...
                                                            <div className="rating-progress-label">
                                                                1<i className="fas fa-star ml-1"></i>
                                                            </div>
                                                        </li>
                                                    </ul>
                                                </div>
                                        ...
                                        <div className="col-12">
                                            <div className="col-12 text-justify py-2 mb-3 bg-gray">
                                                <div className="row">
                                                    ...
                                                    <div className="col-12">
                                                        <small>
                                                            <i className="fas fa-clock mr-2"></i>5 hours ago
                                                        </small>
                                                    </div>
                                                </div>
                                            </div>
